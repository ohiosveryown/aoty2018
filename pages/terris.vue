...
<main>
  ...
  <!-- friends -->
  <h5 class="op-5 subtitle f-space">Terris' List</h5>

  <ul class="">
    <!-- 🎧 -->
    <li class="linkOne">
      <nuxt-link to='/rh/no-rain-no-flowers'>
        <h3 class="f-mabry tar"><span class="op-2">TJ </span>5</h3>
        <figure class="">
    ...
    <li class="linkTwo">
      <nuxt-link to='/rh/green'>
        <h3 class="f-mabry tar"><span class="op-2">TJ </span>4</h3>
        <figure class="">
    ...
    <li class="linkThree">
      <nuxt-link to='/rh/november'>
        <h3 class="f-mabry tar"><span class="op-2">TJ </span>3</h3>
        <figure class="">
    ...
    <li class="linkFour">
      <nuxt-link to='/rh/pieces-of-a-man'>
        <h3 class="f-mabry tar"><span class="op-2">TJ </span>2</h3>
        <figure class="">
    ...
    <li class="linkFive">
      <nuxt-link to='/rh/fetti'>
        <h3 class="f-mabry tar"><span class="op-2">TJ </span>1</h3>
        <figure class="">
    ...
    <li class="linkNext">
      <nuxt-link to='/jordan'>
        ...
        <figure class="">
          ...
          <h5 class="f-space">Presented by Jordan</h5>
        </figure>
      </nuxt-link>
    </li>
  </ul>
