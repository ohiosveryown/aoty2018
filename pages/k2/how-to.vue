        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">KF </span>5</h3>
            </div>
            <img src="@/assets/img/k2/05.jpg" alt="Rainbow Kitten Surprise">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">Alternative</h4>
            <h1 class="album f-mabry">How To: Friend, Love, Freefall</h1>
            <h3 class="artist f-space">Rainbow Kitten Surprise</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/5vyt44455ipNNVSYq8fYY7" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>Offering a refreshingly mature twist on indie pop, Rainbow Kitten Surprise’s third album ‘How to: Friend, Love, Freefall’ reaffirms their ability to simultaneously break and soothe the hearts of listeners.</p>

          <p>While many of the elements utilized in How to… are familiar to longtime listeners, RKS couldn’t get away without implementing some new tricks on their major label debut. “Moody Orange” is introduced with a rapid, rap-like first verse. The album’s tracks are sandwiched between two of its most compelling tunes: “Pacific Love”and “Polite Company.”The former is an a-cappella introduction to the work of art that is How to…, while the latter is a mellow, piano-driven finale that is comparatively simpler than RKS’ other work, but remains bold in and of itself.</p>

          <div class="byline mt-2 tar">
            <h4>
              <a href="http://atwoodmagazine.com/htflf-rks-how-to-friend-love-freefall-rainbow-kitten-surprise-review/" target="_blank">—Atwood Magazine</a>
            </h4>
          </div>
        </article>
      </div>
