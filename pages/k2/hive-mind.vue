        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">KF </span>1</h3>
            </div>
            <img src="@/assets/img/k2/01.jpg" alt="The Internet">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">R&amp;B</h4>
            <h1 class="album f-mabry">Hive Mind</h1>
            <h3 class="artist f-space">The Internet</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/7bKxc7UstlRxOtNBvLjGSs" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>The fourth album from the R&amp;B collective is a peak example of their combined powers. It simplifies their sound with soft-focus blues, plush arrangements, and deep-in-the-ground grooves.</p>

          <p>Their fourth album, Hive Mind, is an act of collective conviction. It simplifies and shores up the Internet sound with soft-focus blues, plush arrangements, and deep-in-the-ground grooves. The beats are shapelier, more boldly defined, and yet they still have the capacity to bleed into each other. “They gon’ get us to come together,” a chorus of voices sings on the album’s opening song, each utterance louder than the one before. And just as the title implies, they are more in sync here than ever.</p>

          <div class="byline mt-2 tar">
            <h4>
              <a href="https://pitchfork.com/reviews/albums/the-internet-hive-mind/" target="_blank">—Pitchfork</a>
            </h4>
          </div>
        </article>
      </div>
