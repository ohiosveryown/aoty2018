        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">RH </span>5</h3>
            </div>
            <img src="@/assets/img/rh/05.jpg" alt="Sabrina Claudio">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">R&amp;B/Soul</h4>
            <h1 class="album f-mabry">No Rain, No Flowers</h1>
            <h3 class="artist f-space">Sabrina Claudio</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/4BTMGOsnbzI76XYTxAn5K8" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>No Rain, No Flowers opens with a few of those sighs laid over plangent keyboards and pretty, understated bass; it’s an invitation to sink in, to join the singer in her languor. That’s where things stay for the next 28 minutes. This album is consistently suave, admirably steady.</p>

          <p>It’s a soothing balm for whatever ails you, and the album certainly contains plenty of ammunition for a playlist like “Chilled Hits.” But when Claudio wonders, “did we lose our minds?” it’s unnerving: The unerring evenness of the music means you can’t tell. That is part of this sound’s appeal — and part of its drawback.</p>

          <div class="byline mt-2 tar">
            <h4>
              <a href="https://www.rollingstone.com/music/music-album-reviews/review-sabrina-claudio-is-smooth-and-steady-on-no-rain-no-flowers-712330/" target="_blank">—Rolling Stone</a>
            </h4>
          </div>
        </article>
      </div>
