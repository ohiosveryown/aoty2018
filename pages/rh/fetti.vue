        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">RH </span>1</h3>
            </div>
            <img src="@/assets/img/sr/04.jpg" alt="Curren$y, Freddie Gibbs">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">Rap/Hip-Hop</h4>
            <h1 class="album f-mabry">Fetti</h1>
            <h3 class="artist f-space">Curren$y, Freddie Gibbs, The Alchemist</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/0iwOtdhPYur2MuGMsTbVqn" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>The tape is a short, sweet, and potent mix, an example of the good that can happen when seasoned vets link up and operate under the radar and outside of the major label system.</p>

          <p>Like a collaborative project conceived on a hip-hop blog’s message board in 2012, Fetti is an underground rap fan’s dream come true. At just nine tracks—some as brief as a minute and 40 seconds—the tape is a short, sweet, and potent mix of what Curren$y, Freddie Gibbs, and producer Alchemist do best. It is also an example of the good that can happen when seasoned vets link up and operate under the radar and outside of the major label system.</p>

          <div class="byline mt-2 tar">
            <h4>
              <a href="https://pitchfork.com/reviews/albums/freddie-gibbs-currendollary-the-alchemist-fetti/" target="_blank">—Pitchfork</a>
            </h4>
          </div>
        </article>
      </div>
