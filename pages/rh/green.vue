        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">RH </span>4</h3>
            </div>
            <img src="@/assets/img/rh/04.jpg" alt="Robohands">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">Jazz</h4>
            <h1 class="album f-mabry">Green</h1>
            <h3 class="artist f-space">Robohands</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/6OxIEWUGenESgfvRgjSrGQ" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>If you’ve seriously looking at the state of music over the last few years then you will indeed see that incredible Jazz vinyl releases from new heavyweights are on the upswing.  From Estonia to the UK, Finland to Japan, New York to Kansas City and all points in between, artists are recording some of their finest works reminiscent of a time when Jazz was a solid selling genre and hopefully we’ll be seeing that same in the present. Village Life Records who always seems to have a release up their sleeves and ready to make it’s debut sets up their next at to bat home run with their first in the Jazz category release from Robohands.</p>

          <p>The “Green” LP is 10 cuts of smooth ambient Jazz played by a cast of musicians including Andy Baxter (Robohands) (Drums, Guitar, Bass, Piano and Synths),  Jo Hunter (Tenor Saxophone), Francesca Uberti (vocals on 1 track) and Peter Milanovic (various Bass and Woodwind on 2 tracks).</p>

          <div class="byline mt-2 tar">
            <h4>
              <a href="https://nostalgiaking.com/2018/05/14/robohands-green/" target="_blank">—Nostalgia King</a>
            </h4>
          </div>
        </article>
      </div>
