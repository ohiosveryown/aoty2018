        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">SR </span>2</h3>
            </div>
            <img src="@/assets/img/sr/02.jpg" alt="Buddy">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">Rap/Hip-Hop</h4>
            <h1 class="album f-mabry">Harlan &amp; Alondra</h1>
            <h3 class="artist f-space">Buddy</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/7xkt4VVkUfC7MLtb2axxiC" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>The pressure for an artist to put politics at the forefront of their music nowadays can be crippling to those who don’t have the experience or language to articulate it well. For anybody coming out of Compton’s scene right now, the pressure is even greater; almost every notable rap star to twist their music with a sense of social justice into it has stemmed from the Californian county in the past few years.</p>

          <p>But Buddy, the multi-talented rapper and singer who hails from hip-hop’s promised land, seems to be making music with that pressure at the back of his mind. On his debut record, Harlan &amp; Alondra, issues surrounding his come up and his position in America today don’t override his bright and cheeky musical personality. If DAMN. was Compton’s super-charged Trojan horse, ploughing through the gates of the White House holding a middle finger up to the fucked up establishment, Harlan &amp; Alondra is (for the most part) sauntering on a pushbike behind it, reading the room and presenting the same message in a much more languid, soulful, and coded way.</p>

          <p>With his debut record, Buddy has created something that celebrates the genres that play a part in creating California’s musical history. It might be a modest beginning for the 24-year-old, but he deserves to be seen in the same light artists like Anderson .Paak and Kendrick. After all, in an era of rap records that seem stuffy, indulgent, and overlong (*cough* Culture II and Scorpion *cough*), Harlan &amp; Alondra’s eclectic, sun-soaked feel doesn’t out-stay its welcome, and is as culturally vital as it is refreshing.</p>

          <div class="byline mt-2 tar">
            <h4>
              <a href="https://www.highsnobiety.com/p/buddy-harlan-and-alondra-review/" target="_blank">—High Snobiety</a>
            </h4>
          </div>
        </article>
      </div>
