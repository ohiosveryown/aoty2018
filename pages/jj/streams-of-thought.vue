        ...
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">JJ </span>5</h3>
            </div>
            <img src="@/assets/img/jj/05.jpg" alt="Black Thought">
          </figure>

          <article class="detail-details">
            <h4 class="genre op-4 f-space">Rap/Hip-Hop</h4>
            <h1 class="album f-mabry">Streams of Thought Vol. 2</h1>
            <h3 class="artist f-space">Black Thought</h3>
          </article>
        </header>

        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/43gvMxNfrpDBflg9LU5uZ9" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>Your favorite emcee’s favorite emcee — Black Thought is arguably the most consistent rapper of the last 25 years. Tariq’s delivery is technically sound, and he can seemingly rap at will without breaking a sweat. Salaam Remi’s horn-tinged production keeps the overall vibe of this EP steady from front-to-back. His production paired with Black Thought’s vocals gives this project a post golden age hip-hop feel. Even the final track, “Conception”, reminds me of the closing moments of Pharoahe Monch’s “Desire”, and I’m not mad at that.</p>
