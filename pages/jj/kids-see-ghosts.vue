    ...
    <main class="">
      <div class="detail-main mw">
        <header class="detail-header">
          ...
          <figure class="detail-figure">
            <div class="eyebrow">
              ...
              <h3 class="f-mabry"><span class="op-2">JJ </span>4</h3>
            </div>
            <img src="@/assets/img/jj/04.jpg" alt="Kids See Ghosts">
          </figure>
        ...
        <section class="mini-player">
          <iframe src="https://open.spotify.com/embed/track/2I3dW2dCBZAJGj5X21E53k" width="100%" height="80" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
        </section>

        <article class="detail-copy">
          <p>Coming fresh off the heels of his most lackluster solo effort to date and yet another Twitter rant, Kanye West teams up with Kid Cudi to deliver the third project birthed from the “Wyoming Sessions”. At the time of its release, it seemed like there was nothing that could be done to redeem Kanye from his latest antics. However, this project felt like a return to form for both artists. Give me 20 minutes of Cudi humming over melancholy production, and I’m a happy customer. The Kurt Cobain sample at the end is equal parts dope and haunting. It also doesn’t hurt when you have a cameo appearance from Mos Def for the title track.</p>
